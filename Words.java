/* bY wEmOdUcHeL
 * After creating the word class, we now create a words class allowing us to have a list of 
 * words empty that we can fill up later and also this class can return a random word
